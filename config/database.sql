...
VALUES (40380, 20, 'Sheep BrickHeadz',
        '<h3>BrickHeadz theme:</h3>\n\n<p>This set features an adorable sheep with a cute, blocky design, perfect for collectors and fans of the BrickHeadz series.</p>',
        1999, '2020-01-01'),
       (75224, 20, 'Sith Infiltrator Microfighter',
        '<h3>Star Wars theme:</h3>\n\n<p> A mini version of Darth Maul\'s Sith Infiltrator, part of the LEGO Star Wars Microfighters series, great for Star Wars enthusiasts.</p>',
        1599, '2019-01-01'),
       (75223, 20, 'Naboo Starfighter Microfighter',
        '<h3>Star Wars theme:</h3>\n\n<p> A compact, easy-to-build model of the Naboo Starfighter, perfect for young Star Wars fans.</p>',
        1599, '2019-01-01'),
       (75228, 20, 'Escape Pod vs. Dewback Microfighters',
        '<h3>Star Wars theme:</h3>\n\n<p> This set features a Dewback and an Escape Pod, each with a mini-figure from the Star Wars saga, perfect for imaginative play.</p>',
        2999, '2019-01-01'),
       (75317, 20, 'The Mandalorian & The Child BrickHeadz',
        '<h3>Star Wars theme:</h3>\n\n<p> A BrickHeadz double pack featuring The Mandalorian and The Child (Baby Yoda), perfect for fans of the popular Star Wars series.</p>',
        2999, '2020-08-01'),
       (40379, 20, 'Valentine\'s Bear',
        '<h3>BrickHeadz theme:</h3>\n\n<p>A seasonal BrickHeadz set featuring a charming Valentine\'s Bear holding a heart, ideal for Valentine\'s Day.</p>',
        1999, '2020-01-01'),
       (40354, 10, 'Dragon Dance',
        '<h3>Seasonal theme:</h3>\n\n<p>This Chinese New Year-themed set features a vibrant and detailed dragon dance scene, complete with minifigures and traditional decorations.</p>',
        8999, '2019-01-01'),
       (40440, 10, 'German Shepherd',
        '<h3>BrickHeadz theme:</h3>\n\n<p>A BrickHeadz pet set featuring a cute German Shepherd and puppy, great for dog lovers.</p>',
        1999, '2021-01-01'),
       (21108, 30, 'Ghostbusters Ecto-1',
        '<h3>Ideas theme:</h3>\n\n<p>A LEGO Ideas set featuring the iconic Ecto-1 car from the Ghostbusters movies, complete with minifigures of the Ghostbusters team.</p>',
        7999, '2014-06-01'),
       (10226, 30, 'Sopwith Camel',
        '<h3>Creator Expert theme:</h3>\n\n<p> A detailed model of the Sopwith Camel biplane, part of the LEGO Creator Expert series, perfect for aviation enthusiasts.</p>',
        13999, '2012-06-01'),
       (6907, 10, 'Cosmic Cruiser',
        '<h3>Space theme:</h3>\n\n<p>A classic LEGO Space set featuring a detailed cosmic cruiser spacecraft, part of the Futuron sub-theme.</p>',
        2999, '1987-01-01'),
       (6086, 100, 'Black Knight\'s Castle',
        '<h3>Castle theme:</h3>\n\n<p>A large, fortified castle set from the LEGO Castle theme, complete with knights, horses, and secret passages.</p>',
        10999, '1992-01-01'),
       (6990, 100, 'Monorail Transport System',
        '<h3>Space theme:</h3>\n\n<p>A futuristic monorail system set, part of the LEGO Space theme, featuring a full track, stations, and space-themed vehicles.</p>',
        14999, '1987-01-01'),
       (6875, 101, 'Spy Trak 1',
        '<h3>Space theme:</h3>\n\n<p>A classic set from the LEGO Space theme, featuring a high-tech, mobile spying unit with various play features.</p>',
        1999, '1988-01-01'),
       (885, 101, 'Space Scooter',
        '<h3>Space theme:</h3>\n\n<p>A small, classic LEGO Space set featuring a simple yet iconic space scooter vehicle.</p>',
        999,        '1979-01-01');
